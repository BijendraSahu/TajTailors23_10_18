        ...
        <div class="row top_menubox">
            ...
            <div class="main_logo">
                <a href="{{url('/')}}" class="top_logo_box">
                        <img src="{{url('images/taj-logo-big.png')}}" alt="Taj Tailors Logo" class="main_logo_big" />
                        <img src="{{url('images/taj-logo-small.png')}}" alt="Taj Tailors Logo" class="main_logo_small" />
                </a>
            </div>
                ...
                <div class="login_with_baskit">
                    <ul>
                        @if(!isset($_SESSION['user_master']))
                            ...
                            <li><a class="head_a" href="{{url('/about')}}">About</a></li>
                            <li onclick="How_slide();">How it works</li>
                            <li><a class="head_a" href="{{url('product_list')}}">Product</a></li>
                            <li><a class="head_a menu_main_txt" href="{{url('measure')}}">Appointment</a></li>
                        ...
                        @else
                            ...
                            <li><a class="head_a" href="{{url('product_list')}}">Product</a></li>
                            <li><a class="head_a menu_main_txt" href="{{url('measure')}}">Appointment</a>
                            </li>
                            <li>
